...
public class DLL7 {
    ...
    // otomatis disimpan di index ke-2
    public int tambahAntrianPrioritas(String nama, String hp) {
        int nomorBaru;
        if (isEmpty()) {
            nomorBaru = 1;
        } else {
    ...
    // otomatis masuk urutan/index ke-2
        else {
            Pembeli7 setelahHead = head.next;
            head.next = baru;
            baru.prev = head;
...
//buatkan 2 antrian normal dan antrian prioritas otomatis ditambahkan di index ke 2